...
const {
  ...
  KEY_VALUE_SKYSCANNER_TOKEN_KEY_ID,
  KEY_VALUE_MICROSOFT_ID_KEY_ID,
  KEY_VALUE_MICROSOFT_PASSWORD_KEY_ID,
} = process.env;
...
const loadSecrets = async () => {
  ...
  const SKYSCANNER_TOKEN = (await getSecret(client, KEY_VAULT_BASE_URL, 'SKYSCANNER-TOKEN', KEY_VALUE_SKYSCANNER_TOKEN_KEY_ID)).value;
  const MICROSOFT_APP_ID = (await getSecret(client, KEY_VAULT_BASE_URL, 'MICROSOFT-APP-ID', KEY_VALUE_MICROSOFT_ID_KEY_ID)).value;
  const MICROSOFT_APP_PASSWORD = (await getSecret(client, KEY_VAULT_BASE_URL, 'MICROSOFT-APP-PASSWORD', KEY_VALUE_MICROSOFT_PASSWORD_KEY_ID)).value;
  return {
    LUIS_APP_ID,
    LUIS_APP_KEY,
    SKYSCANNER_TOKEN,
